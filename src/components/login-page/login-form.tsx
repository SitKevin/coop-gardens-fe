...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-8 md:p-12">
            <div className="flex flex-col gap-8">
              ...
              <div className="grid gap-3">
                ...
                <Input id="password" type="password" required className="h-12 text-2xl" />
              </div>
      ...
      <div className="text-balance text-center text-xl text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Bằng việc tiếp tục, bạn đã đồng ý với <a href="#">Điều khoản Sử dụng</a>{" "}
